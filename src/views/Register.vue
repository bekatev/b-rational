...
async function onSubmit() {
  ...
  try {
    ...
    localError.value = e?.message || 'Sign up failed.'
  }
}
</script>
...
<template>
  <div class="min-h-dvh grid place-items-center p-6">
    <div class="w-full max-w-md card-glass p-6 space-y-4">
      ...
      <div class="text-sm text-neutral-500">Already have an account? <router-link to="/login" class="underline">Log in</router-link></div>
